...
class PacketMove():
    ...
    def write(self):
        return (
        self.main.protocolmap.getProtocol(self) + "#" + str(self.main.id) + "#" + str(self.x) + "#" + str(self.y))
    ...
    def handle(self):
        if self.id == int(self.main.id):
            self.main.fenetregame.canvas.move(self.main.fenetregame.Pion, self.y - self.main.fenetregame.posy,
            ...
            for b in self.main.fenetregame.other:
                if self.main.fenetregame.listitem[int((self.main.fenetregame.other[b][0]) / 22)][
                    int((self.main.fenetregame.other[b][1]) / 22)] in self.main.fenetregame.maptemp:
